      ...
      >
        ...
        <div className="flex items-center justify-end gap-4">
          ...
          <button
            ...
            className="relative p-2 text-muted-foreground hover:text-accent-foreground transition-colors"
          >
          ...
          <Button
            ...
            className="size-8 flex aspect-square h-fit select-none items-center justify-center rounded-md border cursor-pointer"
          >
            {open ? (
...
function MainMobileMenu({ userLoggedIn, onLinkClicked }: MainMobileMenuProps) {
  ...
  return (
    <div
      className="fixed w-full inset-0 z-50 mt-[64px] overflow-y-auto bg-background backdrop-blur-md animate-in fade-in-0"
    >
